...
O segundo projeto é um projeto pessoal de um site de criação de personagens para RPG de mesa. Por RPG de mesa ser um passamento que eu gosto muito e envolver sistemas complexo na hora de desenvolver uma aplicação completa, decidi iniciá-lo como uma forma de demonstrar meus avanços de conhecimento na área de desenvolvimento Web. Esse projeto utiliza HTML, CSS, Typescript, Angular, AspNet, Figma e ainda estou escolhendo uma ferramenta para fazer a modelagem e intergração do banco de dados.
...
<h3 align="left">Desenvolvimento Web</h3>
<h4>HTML, CSS, JAVASCRIPT, ANGULAR, BOOTSTRAP, FIGMA, TYPESCRIPT</h4>
